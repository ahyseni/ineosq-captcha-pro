=== Captcha Pro by IneosQ ===
Contributors: ineosq
Donate link: https://ineosq.com/donate/
...
[View Demo](https://ineosq.com/demo-for-captcha/?ref=readme)
...
* Add captcha to:
    ...
    * Reset password form
    * Comments form
    * [Contact Form](https://ineosq.com/products/wordpress/plugins/contact-form/?k=7f973058ee3bd3a18934b5e13b857d6f)
    * [Car Rental V2 Pro](https://ineosq.com/products/wordpress/plugins/car-rental-v2/?k=9feda3ea8564e0b0707c5434786ddf24)
    * Custom form
* Choose Captcha type:
    * Invisible
...
>   * [Subscriber](https://ineosq.com/products/wordpress/plugins/subscriber/?k=ac02c12d6e17bc91f4cc636eec0a0348)
...
> * Merge IP addresses from [Limit Attempts](https://ineosq.com/products/wordpress/plugins/limit-attempts/?k=a9ab60b2d4016ae9c809733d84012988) plugin with Captcha Allow List
...
> * Get answer to your support question within one business day ([Support Policy](https://ineosq.com/support-policy/))

If you have a feature suggestion or idea you'd like to see in the plugin, we'd love to hear about it! [Suggest a Feature](https://support.ineosq.com/hc/en-us/requests/new)

= Documentation & Videos =

* [[Doc] User Guide](https://ineosq.com/documentation/captcha/captcha-user-guide/)
* [[Doc] Installation](https://ineosq.com/documentation/how-to-install-a-wordpress-product/how-to-install-a-wordpress-plugin/)
* [[Doc] Purchase](https://ineosq.com/documentation/how-to-purchase-a-wordpress-plugin/how-to-purchase-wordpress-plugin-from-ineosq/)
...
Visit our Help Center if you have any questions, our friendly Support Team is happy to help - <https://support.ineosq.com/>

= Affiliate Program =

Earn 20% commission by selling the premium WordPress plugins and themes by IneosQ — https://ineosq.com/affiliate/
...
Some of these translations are not complete. We are constantly adding new features which should be translated. If you would like to create your own language pack or update the existing one, you can send [the text of PO and MO files](https://codex.wordpress.org/Translating_WordPress) to [IneosQ](https://support.ineosq.com/hc/en-us/requests/new) and we'll add it to the plugin. You can download the latest version of the program for work with PO and MO [files Poedit](https://www.poedit.net/download.php).

= Recommended Plugins =

* [Limit Attempts](https://ineosq.com/products/wordpress/plugins/limit-attempts/?k=a9ab60b2d4016ae9c809733d84012988) - Protect WordPress website against brute force attacks. Limit rate of login attempts.
* [Updater](https://ineosq.com/products/wordpress/plugins/updater/?k=a907f8db1dcb6aae7a71a2a90c2f186b) - Automatically check and update WordPress website core with all installed plugins and themes to the latest versions.
* [Contact Form](https://ineosq.com/products/wordpress/plugins/contact-form/?k=a9ab60b2d4016ae9c809733d84012988) - Simple contact form plugin any WordPress website must have.
* [Subscriber](https://ineosq.com/products/wordpress/plugins/subscriber/?k=2ce0827916414c9c8576110f13560030) - Add email newsletter sign up form to WordPress posts, pages and widgets. Collect data and subscribe your users.

== Installation ==

1. Upload the `ineosq-captcha-pro` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin via the 'Plugins' menu in WordPress.
3. Plugin settings are located in 'Captcha'.

[View a Step-by-step Instruction on Captcha Installation](https://ineosq.com/documentation/how-to-install-a-wordpress-product/how-to-install-a-wordpress-plugin/).
...
Please don't use the next form slugs since they are predefined by plugin settings: general, wp_login, wp_register, wp_lost_password, wp_comments, ineosq_contact, ineosq_subscriber, buddypress_register, buddypress_comments, buddypress_group, cf7_contact, woocommerce_login, woocommerce_register, woocommerce_lost_password, woocommerce_checkout.
- Save file changes;
...
You need to replace the output and response checking for the CAPTCHA in your form according to [the instruction](https://support.ineosq.com/hc/en-us/articles/202353439) or the appropriate point in the FAQ (see "I would like to add Captcha to the custom form on my website. How can I do this?").
...
- Install and activate [Limit Attempts](https://ineosq.com/products/wordpress/plugins/limit-attempts/?k=a9ab60b2d4016ae9c809733d84012988) plugin to get additional anti-spam protection and low-down bots registration rate.

= I have some problems with the plugin's work. What Information should I provide to receive proper support? =

Please make sure that the problem hasn't been discussed yet on our forum (<https://support.ineosq.com>). If no, please provide the following data along with your problem's description:
- The link to the page where the problem occurs
- The name of the plugin and its version. If you are using a pro version - your order number.
- The version of your WordPress installation
- Copy and paste into the message your system status report. Please read more here: [Instruction on System Status](https://ineosq.com/documentation/admin-panel-issues/system-status/)

== Screenshots ==

1. Registration form with Captcha Pro.
2. Lost password form with Captcha Pro.
3. Login form with Captcha Pro.
4. Comments form with Captcha Pro.
5. BuddyPress Registration form with Captcha Pro.
6. BuddyPress Comments form with Captcha Pro.
7. BuddyPress "Create a Group" form with Captcha Pro.
8. Subscriber form with Captcha Pro.
9. Contact form with Captcha Pro.
10. WooCommerce Login and Register forms with Captcha Pro.
11. WooCommerce Lost Password form with Captcha Pro.
12. WooCommerce Checkout form with Captcha Pro.
13. Contact Form 7 with Captcha Pro.
14. Jetpack Contact Form with Captcha Pro.
15. Gravity Form with Captcha Pro.
16. wpForo Login form with Captcha Pro.
17. wpForo Register form with Captcha Pro.
18. wpForo New topic form with Captcha Pro.
19. wpForo Reply form with Captcha Pro.
20. MailChimp for Wordpress form with Captcha Pro.
21. WPForms for Wordpress form with Captcha Pro.
22. Elementor Pro Contact form with Captcha Pro.
23. Login form with Optical Character Recognition Captcha Type.
24. Login form with Slide Captcha Type.
25. Captcha Settings page.
26. Captcha Network Settings page.
27. Captcha Packages page.
28. Captcha Allow list page.
...
* Update : INEOSQ Panel section was updated.
* NEW : The compatibility with Elementor Pro has been added.

= V5.1.5 - 10.08.2021 =
* Update : All functionality was updated for WordPress 5.8
* Update : Packages for slide captcha was updated.
* NEW : The compatibility with WPForms has been added.
...
= V5.1.3 - 17.06.2021 =
* NEW : Ability to edit the appearance of slide captcha has been added.
* NEW : Ability to edit messages of slide captcha has been added.
* Bugfix : The issue with submitting Contact form 7 has been fixed.
* Bugfix : The issue with displaying captcha in the form of creating a new topic and in the reply form in WpForo has been fixed.
...
* NEW : The compatibility with Gravity Forms has been added.

= V5.1.0 - 19.01.2021 =
* Update : INEOSQ panel section was updated.
* Bugfix : Bug related to incorrect Captcha displaying at used several Image Packages has been fixed.
...
* Bugfix : The compatibility with Ninja Form has been fixed.
...
* Update : INEOSQ Menu Functionality is improved.
...
= V5.0.4 - 16.04.2019 =
* NEW : Compatibility with Ninja Forms has been added.
...
= V5.0.2 - 10.10.2018 =
* NEW : Compatible with MailChimp for WordPress has been added.
* NEW : Compatible with bbPress has been added.
* NEW : Compatible with wpForo has been added.
...
= V5.0.1 - 03.04.2018 =
* Bugfix : Bug related to inability to save settings after upgrade from Free to Pro version has been fixed.
...
* Update : The compatibility with Contact Form 7 was updated.
...
= V4.2.7 - 14.11.2016 =
* NEW : An ability to edit the reason of adding to whitelist has been added.
* Update : The French language file has been updated.
* Update : The compatibility with new Limit Attempts by IneosQ version and WooCommerce forms has been updated.
* Update : Captcha checking on blog signup page has been added.
...
= V4.2.5 - 14.09.2016 =
* Bugfix : The compatibility bug between CAPTCHA by IneosQ and Contact Form 7 plugins has been fixed.
...
* NEW : The "[ineosq_captcha]" shortcode is added.
...
* Update : INEOSQ panel section has been updated.
...
* Bugfix : The bug of displaying captha error when adding a new user on the multisite has been fixed.
* Update : The French language file has been updated.
...
* New : Ability to load list of IP from whitelist of Limit Attempts by IneosQ plugin to Captcha whitelist.
* New : Ability to use whitelist of Limit Attempts by IneosQ plugin.
...
= V1.4.1 - 16.05.2014 =
* Budfix : The bug with Buddypress buttons is fixed.
...
= V1.3.4 - 14.01.2013 =
* Update : INEOSQ Panel section is updated.
...
= V1.7.0 =
The French file has been updated. INEOSQ panel section was updated.

= V1.6.9 =
An ability to load image packages has been added. An ability to use SVG images for CAPTCHA has been added. A compatibility with the WooCommerce Checkout form has been added. A notice about Captcha's time limit expiration has been added. Compatibility options with the WooCommerce forms have been updated. The appearance of the "Enable image packages" settings block has been updated. The French file has been updated. The bug with the displaying images from different packages has been fixed.

= V1.6.8 =
Functionality to use Captcha with WooCommerce was added. Ability to add custom styles. Functionality to use Captcha with BuddyPress login widget was added. Lower-case equivalents for all numbers have been changed.
...
= V1.6.5 =
Error with image packages selecting for using in Captcha has been fixed.

= V1.6.4 =
Ability to use images in Captcha. Ability to reload Captcha. Ability to load list of IP from whitelist of Limit Attempts by IneosQ plugin to Captcha whitelist. Ability to use whitelist of Limit Attempts by IneosQ plugin. Ability to set time limit for different forms, after which the Captcha can not be passed. Bug with Captcha reloading when forms data handled via ajax was fixed. XSS vulnerability with displaying search results for Captcha whitelist was fixed (thanks to [Colette Chamberland](mailto:colette@wordfence.com)). XSS vulnerability with user authentication was fixed (thanks to [Colette Chamberland](mailto:colette@wordfence.com)). Structure of plugin`s settings page was updated. The French and Hungarian language files were updated. Functional compatibility with the plugin Limit Attempts Pro was updated. Compatible with Limit Attempts Pro v1.1.1 and older will not be supported any more after 1.06.2016.
...
= V1.6.0 =
We updated all functionality for Limit Attempts Pro plugin V1.0.9.

= V1.5.9 =
We updated all functionality for Contact Form 7 v4.2.
...
= V1.5.7 =
The French language file is updated. We updated all functionality for wordpress 4.2.2.

= V1.5.6 =
We updated all functionality for wordpress 4.2.1.

= V1.5.5 =
The Croatian, French and Farsi languages file are updated. The bug with undefined function 'get_plugin_data' is fixed. Error display with the comments form was changed.

= V1.5.4 =
We added the ability to change error messages.

= V1.5.3  =
We updated all functionality for plugin Subscriber Pro.

= V1.5.2  =
We updated all functionality for Contact Form 7 v4.1.

= V1.5.1 =
The language files are updated. We updated all functionality for wordpress 4.1.

= V1.5.0 =
Security Vulnerability was fixed. The bug with error message on multisite is fixed. The bug with buddypress comment form is fixed. We added functionality to configure Captcha on Network.

= V1.4.9 =
The bug with undefined function is fixed.
...
= V1.4.7 =
The Brazilian Portuguese language file is updated. We added filter 'cptchpr_forms_list' in the plugin settings page.

= V1.4.6 =
The Farsi/Persian language file is updated. We updated all functionality for wordpress 4.0.
...
= V1.4.3 =
We updated all functionality for Contact Form 7 v3.9.

= V1.4.2 =
We added functionality to use Captcha with Subscriber.

= V1.4.1 =
The bug with Buddypress buttons is fixed.
...
= V1.3.9 =
We updated all functionality for wordpress 3.8.3.

= V1.3.8 =
Plugin optimization is done. The French language file is updated.

= V1.3.7 =
The bug of displaying captha error when adding a new user in the multisite is fixed.
...
= V1.3.4 =
INEOSQ Panel section is updated.

= V1.3.3 =
We updated all functionality for wordpress 3.8. The French language file is updated.

= V1.3.2 =
A notice when changing settings on the plugin's settings page was added. We added class for the div-block of captcha in the buddypress registration form. The Ukrainian language file is updated. Captcha protection is improved. We updated all functionality for wordpress 3.8-RC1.

= V1.3.1 =
The Indonesian language file is added to the plugin. The Taiwan language file is added to the plugin.

= V1.3 =
Add checking installed wordpress version. We updated security functionality. The French language file is updated.

= V1.2 =
We added ability to use Captcha with plugin Contact Form 7. We updated all functionality for wordpress 3.7.1. Activation of radio button or checkbox by clicking on its label.

= V1.1 =
Ability to change required symbol (asterisk). File format according JavaScript and CSS Coding Standards. We updated all functionality for wordpress 3.7.

= V1.0.3 =
The Italian language file is updated.  The Catalan language file is added to the plugin. The Brazilian Portuguese language file is updated. The Ukrainian language file is updated. The duplicate style is removed. INEOSQ Panel section is updated.

= V1.0.2 =
Captcha protection is improved by changing hidden values in every session. The French language file is updated. We updated all functionality for wordpress 3.6.1.

= V1.0.1 =
We added explanations on the plugin settings page. The German language file is updated in the plugin.

= V1.0 =
We added functionality to use Captcha with BuddyPress.
